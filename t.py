...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/cnl.yaml', help='data.yaml path')
    # parser.add_argument('--data', type=str, default='data/helmet.yaml', help='data.yaml path')
    # parser.add_argument('--data', type=str, default='data/person.yaml', help='data.yaml path')
